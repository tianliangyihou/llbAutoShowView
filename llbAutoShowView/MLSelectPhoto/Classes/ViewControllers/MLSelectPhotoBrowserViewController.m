...
{
    NSInteger currentPage = (NSInteger)((_collectionView.contentOffset.x / _collectionView.ml_width) + 0.5);
...
- (UICollectionViewCell *) collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.photos.count) {
        ...
        // 为了监听单击photoView事件
        scrollView.frame = CGRectMake(0, 20, self.view.frame.size.width, self.view.frame.size.height-40);
